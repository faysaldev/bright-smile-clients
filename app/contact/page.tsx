      ...
      <div className="pb-16 pt-8">
        ...
        <section className="section-padding">
          <div className="container-narrow">
                ...
                <div className="glass-card p-8 sm:p-10 rounded-3xl">
                  ...
                  >
                    ...
                    <Input
                      ...
                      className="rounded-xl py-5"
                    />
                    <Input placeholder="Subject" className="rounded-xl py-5" />
                    <Textarea
                      placeholder="Your Message"
                      rows={5}
                      className="rounded-xl"
                    />
                    <Button className="w-full py-5 rounded-xl gap-2 text-base">
              ...
              <div ref={infoRef} className="space-y-6">
                {[
                  ...
                  },
                  {
                    icon: MapPin,
                    label: "Address",
                    value: "123 Dental Ave, Suite 100, New York, NY 10001",
                  },
                ].map((item) => (
                  <div
                    key={item.label}
                ...
                <a
                  ...
                  className="flex items-center gap-3 glass-card p-5 rounded-2xl hover:scale-[1.02] transition-transform group"
                >
            ...
            <div className="mt-14 rounded-3xl overflow-hidden h-96 shadow-xl">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.215!2d-73.9857!3d40.7484!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDQ0JzU0LjIiTiA3M8KwNTknMDguNSJX!5e0!3m2!1sen!2sus!4v1"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
